...
load_climats <- function(path) {
    table <- vroom::vroom_fwf(path, col_select = seq_along(col_names), col_types = col_types, col_positions = fwf_empty(ftmin, skip = 0, n = 7000, col_names = col_names), show_col_types = FALSE) |>
