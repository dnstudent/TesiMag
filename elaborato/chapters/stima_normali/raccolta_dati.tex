...
\begin{figure}[ht]
  ...
  \input{images/stima_normali/raccolta_dati/reggio_series_plot.tex}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\paperwidth]{images/stima_normali/raccolta_dati/reggio_series_graph.pdf}
...
\begin{figure}[ht]
  ...
  \input{images/stima_normali/correzioni/corrections_deltas.tex}
...
% TODO: sistemare. Spiegare perché il numero di serie è discrepante con quelli riportati dopo (variabile keep, duplicates).
% \begin{table}[ht]
%   \caption{Numero di correzioni apportate}\label{tab:n-corrections}
%   \centering
%   \input{images/stima_normali/correzioni/corrections_summary.tex}
% \end{table}
% TODO: statistiche delle discrepanze per dataset
...
\begin{table}[ht]
  ...
  \begin{threeparttable}
    ...
    \scriptsize
    \input{images/stima_normali/dataset/data.tex}
    \begin{tablenotes}
...
\begin{figure}[ht]
  ...
  \input{images/stima_normali/dataset/monthly_availability.tex}
...
\begin{figure}[ht]
  \centering
  % \includegraphics[width=\textwidth]{images/stima_normali/dataset/elevation_distribution.tex}
  \input{images/stima_normali/dataset/elevation_distribution.tex}
...
\begin{figure}[ht]
  ...
  % \input{images/stima_normali/dataset/merged_contributions.tex}
...
\begin{figure}[ht]
  ...
  \input{images/stima_normali/dataset/improvements.tex}
