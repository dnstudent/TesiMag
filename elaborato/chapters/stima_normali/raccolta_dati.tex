...
Nella tabella~\ref{tab:quick-datasets} sono elencati i dataset impiegati per il lavoro. Nell'appendice~\ref{app:datasets} viene fornita una descrizione dettagliata di contenuti, problematiche e disponibilità dati di ciascuno di essi.\todo{Rimuovere se non faccio}

\begin{table}[ht]
  %  TODO: aggiungere dataset esteri
  \centering
